  ...
  dji13service: [
    {
      ...
      description: "ตรวจสอบและประเมินราคาซ่อมโดรน DJI ทุกรุ่นฟรี ไม่มีค่าบริการ ใช้เวลา 1-2 วันทำการ",
      discountType: "fixed",
      discountValue: "Free diagnosis",
      conditions: "ต้องนำโดรนมาที่ร้านหรือส่งทางไปรษณีย์",
      startDate: "2026-01-01",
      endDate: "2026-12-31",
      active: true,
    },
    {
      id: 2,
      title: "Firmware Update ฟรี",
      description: "อัปเดต Firmware โดรน DJI และ Calibrate Gimbal/IMU/Compass ฟรีค่าบริการ",
      discountType: "fixed",
      discountValue: "Free service",
      conditions: "ต้องนำโดรนมาที่ร้านเท่านั้น",
      startDate: "2026-01-01",
      endDate: "2026-12-31",
      active: true,
    },
    ...
    {
      id: 4,
      title: "ส่วนลดซ่อมโดรน DJI สำหรับลูกค้าขาประจำ",
      description: "ลูกค้าที่ซ่อมกับเรามาแล้วมากกว่า 2 ครั้ง รับส่วนลดค่าซ่อม 10%",
      discountType: "percent",
      discountValue: "10",
      conditions: "แสดงประวัติการซ่อมหรือแจ้ง LINE ID",
      startDate: "2026-01-01",
      endDate: "2026-12-31",
      active: true,
    },
