/* ------------------------------------------------------------------ */
/*  ทีมเอกสาร DJI 13 Store — Channel Configuration                    */
/* ------------------------------------------------------------------ */
...
const DEFAULT_SCHEDULE = [
  { day: "Monday",    open: "09:00", close: "17:00", active: true },
  { day: "Tuesday",   open: "09:00", close: "17:00", active: true },
  { day: "Wednesday", open: "09:00", close: "17:00", active: true },
  { day: "Thursday",  open: "09:00", close: "17:00", active: true },
  { day: "Friday",    open: "09:00", close: "17:00", active: true },
  { day: "Saturday",  open: "09:00", close: "12:00", active: false },
  { day: "Sunday",    open: "09:00", close: "12:00", active: false },
];

function defaultCommon(): ChannelCommonSettings {
  return {
    welcomeMessage: "สวัสดีครับ! ยินดีต้อนรับสู่ ทีมเอกสาร DJI 13 Store\nช่วยเรื่องขึ้นทะเบียนโดรน กสทช. และขออนุญาต CAAT ได้เลยครับ",
    autoReply: true,
    responseDelaySec: 0,
    businessHours: {
      enabled: false,
...
export const channels: ChannelInfo[] = [
  ...
  },
  {
    ...
    facebook: {
      ...
      verifyToken: "",
      persistentMenu: true,
      iceBreakers: ["ขึ้นทะเบียน กสทช.", "ขออนุญาต CAAT", "ปรึกษากฎหมายโดรน"],
...
/**
 * Check if current Bangkok time is within ทีมเอกสาร DJI 13 Store business hours.
...
/**
 * Build the off-hours message shown to customers of ทีมเอกสาร DJI 13 Store.
 */
export function buildOffHoursMessage(): string {
  ...
  return (
    ...
    `⏰ **เวลาทำการ**: จันทร์–ศุกร์ 09:00–17:00 น. | เสาร์–อาทิตย์ปิดครับ\n\n` +
