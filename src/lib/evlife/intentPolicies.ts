...
export const intents: Intent[] = [
  ...
  },
  {
    ...
    responseTemplate: "แบตเตอรี่ LiFePO4 12V สำหรับรถยนต์ไฟฟ้าครับ!\n\nรองรับทุกรุ่น:\n• BYD (Atto 3, Dolphin, Seal, Sealion 6/7) — 5,900 บาท\n• Tesla (Model 3, Model Y) — 6,500 บาท\n• MG (ZS EV, MG4) — 5,500 บาท\n• Neta V — 4,900 บาท | Neta X — 5,500 บาท\n• Volvo EX30/XC40 — 6,500 บาท\n• BMW iX3, Mercedes EQA — 7,500 บาท\n\nรับประกัน 4 ปี + บริการเปลี่ยนถึงบ้าน (On-site) ฟรีในกรุงเทพฯ-ปริมณฑล\n\nใช้รถรุ่นไหนครับ? แจ้งได้เลย จะแนะนำรุ่นที่เหมาะกับรถคุณครับ!",
    active: true,
  },
  {
    ...
    responseTemplate: "มอเตอร์ไซค์ไฟฟ้า EM — EV Life Thailand ตัวแทนอย่างเป็นทางการครับ!\n\nรุ่นที่มีจำหน่าย:\n• EM Legend G.2 — 39,900 บาท | มอเตอร์ 3000W วิ่ง 110 กม./ชาร์จ เร็วสุด 90 กม./ชม. พร้อมส่ง\n• EM Legend Pro — 49,900 บาท | มอเตอร์ 4000W วิ่ง 150 กม./ชาร์จ เร็วสุด 100 กม./ชม. พร้อมส่ง\n• EM Milano — 59,900 บาท | มอเตอร์ 3000W วิ่ง 120 กม./ชาร์จ (พรีออเดอร์)\n• EM Owen LR — 87,200 บาท | มอเตอร์ 3000W วิ่ง 200 กม./ชาร์จ\n\nโปรเดือนนี้: ฟรีจดทะเบียน + พ.ร.บ. + ประกันรถหาย + จัดส่ง + ของแถม!\nผ่อน 0% / ฟรีดาวน์ / ทุกอาชีพออกได้\n\nสนใจรุ่นไหนครับ หรือต้องการทราบรายละเอียดเพิ่มเติม?",
    active: true,
  },
  {
    id: "product_inquiry",
