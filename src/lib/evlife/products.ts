...
export const products: Product[] = [
  ...
  // === มอเตอร์ไซค์ไฟฟ้า EM ===
  {
    id: 3006,
    name: "EM Legend G.2",
    description: "มอเตอร์ไซค์ไฟฟ้า EM Legend G.2 (Generation 2) รุ่นยอดนิยม คุ้มค่าที่สุด มอเตอร์ 3000W แบตเตอรี่ลิเธียม 72V 40Ah วิ่งได้ไกลสุด 110 กม./ชาร์จ ความเร็วสูงสุด 90 กม./ชม. จดทะเบียนได้ พร้อมส่งครบสี\nMotor: 3000W | Battery: 72V 40Ah | Range: 110 km | Top Speed: 90 km/h\nWarranty: มอเตอร์ 5 ปี/30,000 กม. | แบตเตอรี่คอนโทรลเลอร์ 3 ปี/20,000 กม. | ระบบไฟฟ้า 1 ปี/10,000 กม.",
    price: 39900,
    category: "มอเตอร์ไซค์ไฟฟ้า EM",
    image: "https://placehold.co/300x300/d946ef/white?text=EM+Legend+G2",
    tags: ["มอเตอร์ไซค์ไฟฟ้า", "EM", "Legend", "Legend G.2", "G.2", "จดทะเบียนได้", "พร้อมส่ง", "คุ้มค่า"],
    status: "active",
  },
  {
    id: 3002,
    name: "EM Legend Pro",
    description: "มอเตอร์ไซค์ไฟฟ้า EM Legend Pro รุ่นอัปเกรด สมรรถนะสูง มอเตอร์ 4000W แบตเตอรี่ลิเธียม 72V 50Ah วิ่งได้ไกลสุด 150 กม./ชาร์จ ความเร็วสูงสุด 100 กม./ชม. จดทะเบียนได้ พร้อมส่งครบสี\nMotor: 4000W | Battery: 72V 50Ah | Range: 150 km | Top Speed: 100 km/h\nWarranty: มอเตอร์ 5 ปี/30,000 กม. | แบตเตอรี่คอนโทรลเลอร์ 3 ปี/20,000 กม. | ระบบไฟฟ้า 1 ปี/10,000 กม.\nของแถมพิเศษ: กระเป๋าเกะหน้า",
    price: 49900,
    category: "มอเตอร์ไซค์ไฟฟ้า EM",
    image: "https://placehold.co/300x300/ef4444/white?text=EM+Legend+Pro",
    tags: ["มอเตอร์ไซค์ไฟฟ้า", "EM", "Legend Pro", "จดทะเบียนได้", "สมรรถนะสูง", "พร้อมส่ง"],
    status: "active",
  },
  {
    id: 3001,
    name: "EM Milano",
    description: "มอเตอร์ไซค์ไฟฟ้า EM Milano สไตล์คลาสสิก อิตาเลียน ดีไซน์สวยโดดเด่น มอเตอร์ 3000W แบตเตอรี่ลิเธียม 72V 40Ah วิ่งได้ไกลสุด 120 กม./ชาร์จ ความเร็วสูงสุด 90 กม./ชม. จดทะเบียนได้ กำลังเป็นที่สนใจอย่างมาก รถรอผลิต รับพรีออเดอร์\nMotor: 3000W | Battery: 72V 40Ah | Range: 120 km | Top Speed: 90 km/h\nWarranty: มอเตอร์ 5 ปี/30,000 กม. | แบตเตอรี่คอนโทรลเลอร์ 3 ปี/20,000 กม. | ระบบไฟฟ้า 1 ปี/10,000 กม.\nสถานะ: รถรอผลิต พรีออเดอร์",
    price: 59900,
    category: "มอเตอร์ไซค์ไฟฟ้า EM",
    image: "https://placehold.co/300x300/f97316/white?text=EM+Milano",
    tags: ["มอเตอร์ไซค์ไฟฟ้า", "EM", "Milano", "จดทะเบียนได้", "คลาสสิก", "พรีออเดอร์"],
    status: "active",
  },
  {
    id: 3003,
    name: "EM Owen Long Range",
    description: "มอเตอร์ไซค์ไฟฟ้า EM Owen Long Range เน้นระยะทางไกล มอเตอร์ 3000W แบตเตอรี่ลิเธียม 72V 60Ah วิ่งได้ไกลสุด 200 กม./ชาร์จ ความเร็วสูงสุด 85 กม./ชม. เหมาะสำหรับใช้งานในเมืองและระยะทางไกล หากสนใจสอบถามเพิ่มเติม\nMotor: 3000W | Battery: 72V 60Ah | Range: 200 km | Top Speed: 85 km/h\nWarranty: มอเตอร์ 5 ปี/30,000 กม. | แบตเตอรี่คอนโทรลเลอร์ 3 ปี/30,000 กม. | ระบบไฟฟ้า 1 ปี/10,000 กม.",
    price: 87200,
    category: "มอเตอร์ไซค์ไฟฟ้า EM",
  ...
  },
  {
    id: 3004,
    name: "EM Enzo",
    description: "มอเตอร์ไซค์ไฟฟ้า EM Enzo — รุ่นนี้ไม่ผลิตแล้ว แนะนำ EM Legend Pro แทน",
    price: 159000,
    category: "มอเตอร์ไซค์ไฟฟ้า EM",
    image: "https://placehold.co/300x300/8b5cf6/white?text=EM+Enzo",
    tags: ["มอเตอร์ไซค์ไฟฟ้า", "EM", "Enzo"],
    status: "discontinue",
    recommendedAlternative: "EM Legend Pro",
  },
  {
    id: 3005,
    name: "EM Qarez",
    description: "มอเตอร์ไซค์ไฟฟ้า EM Qarez — รุ่นนี้ไม่ผลิตแล้ว แนะนำ EM Legend G.2 แทน",
    price: 69000,
    category: "มอเตอร์ไซค์ไฟฟ้า EM",
    image: "https://placehold.co/300x300/06b6d4/white?text=EM+Qarez",
    tags: ["มอเตอร์ไซค์ไฟฟ้า", "EM", "Qarez"],
    status: "discontinue",
