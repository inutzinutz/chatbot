...
export const products: Product[] = [
  ...
  // === มอเตอร์ไซค์ไฟฟ้า EM (6 รุ่น — ข้อมูลถูกต้อง ณ ก.พ. 2568) ===
  {
    ...
    tags: ["มอเตอร์ไซค์ไฟฟ้า", "EM", "Qarez", "Urban", "RGB", "จดทะเบียนได้", "พร้อมส่ง"],
    status: "active",
  },
  {
    id: 3006,
    name: "EM Legend",
    description: "มอเตอร์ไซค์ไฟฟ้า EM Legend รุ่นยอดนิยม คุ้มค่าที่สุด NO.1 EV Bike of the Year 2025 จดทะเบียนได้ พร้อมส่งครบสี\nMotor: 2000W | Battery: 72V 32Ah | Range: 80 km | Top Speed: 70 km/h | Charge: 4-6 h\nWarranty: มอเตอร์ 5 ปี/30,000 กม. | แบตเตอรี่คอนโทรลเลอร์ 3 ปี/20,000 กม. | ระบบไฟฟ้า 1 ปี/10,000 กม.",
    price: 39900,
    category: "มอเตอร์ไซค์ไฟฟ้า EM",
    image: "https://placehold.co/300x300/d946ef/white?text=EM+Legend",
    tags: ["มอเตอร์ไซค์ไฟฟ้า", "EM", "Legend", "จดทะเบียนได้", "พร้อมส่ง", "คุ้มค่า", "EV Bike of the Year"],
    status: "active",
  },
  {
    id: 3002,
  ...
  },
  {
    ...
    tags: ["มอเตอร์ไซค์ไฟฟ้า", "EM", "Enzo", "เรโทร", "อิตาเลียน", "จดทะเบียนได้", "พร้อมส่ง"],
    status: "active",
  },
  {
    id: 3001,
